...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/SNYBOi0xPH)
...
```sh
npx nx serve numerodis
```

To create a production bundle:

```sh
npx nx build numerodis
```

To see all available targets to run for a project, run:

```sh
npx nx show project numerodis
```
